"""
Discord Webhook Output Plugin — Cyanide Honeypot.
...
class Plugin(OutputPlugin):
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.username: str = config.get("username", "Cyanide Honeypot")
    ...
    def _report_poll_loop(self):
        ...
        headers = {
            ...
            "User-Agent": "CyanideHoneypot/1.0",
        }
