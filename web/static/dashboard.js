...
class AttackCache {
    constructor() {
        this.dbName = 'CyanideAttackCache';
        ...
        this.db = null;
        this.localStorageKey = 'cyanide_attack_cache';
    }
...
• Retention: 24 hours
    ...
    addToAttackTable(event, highlight = true) {
        ...
        addCell('cyanide-hostname-cell', event.cyanide_hostname || 'Unknown');
